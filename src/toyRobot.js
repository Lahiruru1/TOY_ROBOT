...
function initAll(){
    ...
    document.getElementById("exampleA").addEventListener("click",exampleA);
    document.getElementById("exampleB").addEventListener("click",exampleB);
    document.getElementById("exampleC").addEventListener("click",exampleC);
};
